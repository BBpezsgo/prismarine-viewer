...
module.exports = (/** @type {import('mineflayer').Bot} */ bot, { viewDistance = 6, firstPerson = false, port = 3000, prefix = '', _app = null, _http = null }) => {
  const express = require('express')

  const app = _app ?? express()
  const http = _http ?? require('http').createServer(app)
